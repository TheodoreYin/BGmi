...
class BangumiTest(base, TestCase):
    ...
    def test_delete_all(self):
        ...
        for i in range(5):
            ...
            Bangumi.create(name=name, keyword=name, cover=name, update_time='mon', type=models.TYPE_MAINLINE, status=STATUS_UPDATING)
        ...
        for i in range(5):
            name = self.faker.name()
            Bangumi.create(name=name, keyword=name, cover=name, update_time='mon', type=models.TYPE_MAINLINE, status=models.STATUS_UPDATING)
    ...
    def test_get_updating_bangumi(self):
        ...
        for day in Bangumi.week:
            name = self.faker.name()
            bangumi = Bangumi.create(name=name, keyword=name, cover=name, update_time=day, type=models.TYPE_MAINLINE, status=models.STATUS_DELETED)
        ...
        for day in Bangumi.week:
            name = self.faker.name()
            bangumi = Bangumi.create(name=name, keyword=name, cover=name, update_time=day, type=models.TYPE_MAINLINE, status=STATUS_UPDATING)
    ...
    def test_get_all_bangumi(self):
        ...
        for bg in b:
            ...
            self.assertEqual(bg['keyword'], 'name')
